...
export default function VerifyOtpPage() {
  ...
  return (
    <div className="flex justify-center items-center min-h-screen bg-gradient-to-br from-blue-100 via-white to-blue-50">
      <div className="w-full max-w-md bg-white shadow-xl rounded-2xl p-8 text-center border border-blue-100">
        <h1 className="text-3xl font-bold mb-4 text-blue-700">Verify OTP</h1>
